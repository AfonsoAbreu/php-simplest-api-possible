export default class ShopItem {
  ...
  Build () {
    if (this.self) {
      ...
      this.self.children[0].src = this.demoImg ? this.demoImg : "/projeto-teste-pwiii-ds/02-trabalho-pra-mencao/frontend/public/img/placeholder.jpg";//update demoImg
    ...
    if (this.isDemo) {
      ...
      return `
        <a class="bg-gray-100 rounded-lg overflow-hidden mb-10 shadow-lg cursor-not-allowed transition flex flex-col mx-auto w-full" individualId="${this.id}">
          <img src="${this.demoImg ? this.demoImg : "/projeto-teste-pwiii-ds/02-trabalho-pra-mencao/frontend/public/img/placeholder.jpg"}" class="rounded-b-lg object-cover h-56 w-full" onerror="this.src='/projeto-teste-pwiii-ds/02-trabalho-pra-mencao/frontend/public/img/placeholder.jpg'">
      ...
      return `
        <a class="bg-gray-100 rounded-lg overflow-hidden shadow-lg hover:bg-gray-200 cursor-pointer transition flex flex-col h-96 mb-10 w-full min-w-custom max-w-custom md:mx-3 md:flex-1" href="${this.purchaseLink}" target="_blank" individualId="${this.id}">
          <img src="${this.demoImg}" class="rounded-b-lg object-cover h-56 w-full" onerror="this.src='/projeto-teste-pwiii-ds/02-trabalho-pra-mencao/frontend/public/img/placeholder.jpg'">
          <div class="px-5 py-2 flex flex-col h-full flex-grow">
